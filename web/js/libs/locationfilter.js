...
L.Control.Button = L.Class.extend({
    ...
    onAdd: function (buttonContainer) {
        ...
        // Adding clear and grab button -- Phronesis
        this._clearButton           = L.DomUtil.create('a', this.options.className, this._buttonContainer.getContainer());
        this._clearButton.id        = "button-clear-selection"
        this._clearButton.innerHTML = "Clear";

        this._grabButton           = L.DomUtil.create('a', this.options.className, this._buttonContainer.getContainer());
        this._grabButton.id        = "button-grab"
        this._grabButton.innerHTML = "Grab";
    },
...
L.LocationFilter = L.Class.extend({
    ...
    options: {
        enableButton: {
            enableText  : "Show Area Selector",
            disableText : "Hide Area Selector"
        },
